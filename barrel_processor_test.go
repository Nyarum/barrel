...
func TestReadToStruct(t *testing.T) {
	...
	netes := NewProcessor([]byte{0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x04})
...
func BenchmarkReadToStruct(b *testing.B) {
	...
	netes := NewProcessor([]byte{0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x04, 0x00, 0x07, 0x4e, 0x79, 0x61, 0x72, 0x75, 0x6d, 0x00})
